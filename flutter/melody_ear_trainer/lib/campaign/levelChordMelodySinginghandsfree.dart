...
class LevelChordMelodySingingHandsFree extends HandsFreePageAbstract {
  const LevelChordMelodySingingHandsFree({
    super.key,
    required super.audioController,
  });
  static const String routeName = '/levelchordmelodysinginghandsfree';

  @override
  State<LevelChordMelodySingingHandsFree> createState() =>
      _LevelChordMelodySingingHandsFreeState();
}

class _LevelChordMelodySingingHandsFreeState
    extends HandsFreePageAbstractState<LevelChordMelodySingingHandsFree> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Hands-free chord melody singing')),
      body: Padding(
