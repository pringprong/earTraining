...
class LevelChordMelodyIDHandsFree extends HandsFreePageAbstract {
  const LevelChordMelodyIDHandsFree({super.key, required super.audioController});
  static const String routeName = '/levelchordmelodyidhandsfree';

  @override
  State<LevelChordMelodyIDHandsFree> createState() =>
      _LevelChordMelodyIDHandsFreeState();
}

class _LevelChordMelodyIDHandsFreeState
    extends HandsFreePageAbstractState<LevelChordMelodyIDHandsFree> {
  @override
