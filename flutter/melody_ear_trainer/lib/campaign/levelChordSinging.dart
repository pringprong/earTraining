...
class LevelChordSinging extends MelodyPageAbstract {
  const LevelChordSinging({super.key, required super.audioController})
    : super();

  static const String routeName = '/levelchordsinging';
  @override
  LevelChordSingingState createState() => LevelChordSingingState();
}

class LevelChordSingingState extends MelodyPageAbstractState {
  String levelStatus = "";
