...
folder_path = r"C:\Users\pring\Documents\Ukulele\solfege\spoken"
...
for filename in os.listdir(folder_path):
    if filename.endswith(".wav"):
        ...
        # later I learned how to overlay the sound instead of concatenate, so I don't need to truncate
